# Guía de armado paso a paso — Escritorio Gamer Demo
...
Cuando retires los cortes de la tienda, separalos y etiquetalos según la lista de cortes. Todas las piezas salieron de tableros grandes (placas). Verificá que las medidas coincidan antes de empezar.
- 💡 Apoyá siempre las piezas sobre cartón o goma para no rayar la melamina.

## Paso 2: Armá la tapa doble (refuerzo anti-pandeo)

La tapa lleva dos capas: abajo el aglomerado crudo (no se ve) y arriba la melamina decorativa (la que vas a ver y tocar). Poné cola en toda la capa de abajo, apoyá la de arriba bien alineada y atornillá desde abajo con tornillos 4×30 cada ~30 cm. Dejá secar con peso encima.
...
## Paso 3: Armá el cajón de la cajonera (la caja estructural)

Uní los dos laterales de la cajonera con el piso, formando una U. Después cerrala por atrás con el fondo. Pre-perforá SIEMPRE antes de atornillar la melamina para que no reviente el canto.

- **Piezas:** Lateral cajonera interno, Lateral cajonera externo, Piso cajonera, Fondo cajonera
...
- **Piezas:** Lateral izquierdo (pata panel), Parante soporte CPU, Bandeja CPU
...
- 💡 Nunca arrastres el escritorio ya armado: movelo entre dos, levantándolo (R-26).
